...
INSERT INTO `amphures` (`AMPHUR_ID`, `code`, `AMPHUR_NAME`, `name_en`, `PROVINCE_ID`) VALUES
...
CREATE TABLE `approve` (
  `APPROVE_ID` char(6) COLLATE utf8_unicode_ci NOT NULL COMMENT 'รหัสการอนุมัติ',
  `LEAVE_ID` char(10) COLLATE utf8_unicode_ci NOT NULL COMMENT 'รหัสการลางาน',
  `APPROVE_DATE` date NOT NULL COMMENT 'วันที่อนุมัติ',
  `USER_ID` char(6) COLLATE utf8_unicode_ci NOT NULL COMMENT 'รหัสผู้อนุมัติ',
  `APPROVE_STATUS` char(1) COLLATE utf8_unicode_ci NOT NULL COMMENT 'สถานะการอนุมัติ เช่น 0 = ยังไม่ทำการ อนุมัติ 1 = อนุมัติ 2 = ไม่อนุมัติ'
...
INSERT INTO `approve` (`APPROVE_ID`, `LEAVE_ID`, `APPROVE_DATE`, `USER_ID`, `APPROVE_STATUS`) VALUES
('A00001', '6201160001', '2019-01-16', '180001', '1'),
('A00002', '6201160002', '2019-01-16', '180001', '2'),
('A00003', '6201160003', '2019-01-16', '180001', '1'),
('A00005', '6201160005', '2019-01-16', '180001', '1');
...
CREATE TABLE `department` (
  `DEPARTMEMT_ID` int(3) NOT NULL COMMENT 'รหัสหน่วยงาน',
  `DEPARTMEMT_NAME` varchar(50) COLLATE utf8_unicode_ci NOT NULL COMMENT 'ชื่อหน่วยงาน'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `department` (`DEPARTMEMT_ID`, `DEPARTMEMT_NAME`) VALUES
(1, 'ฝ่ายการขาย'),
(2, 'ฝ่ายบัญชี');
...
INSERT INTO `districts` (`DISTRICT_ID`, `POSTCODE`, `DISTRICT_NAME`, `name_en`, `AMPHUR_ID`) VALUES
...
CREATE TABLE `formleave` (
  `LEAVE_ID` char(10) COLLATE utf8_unicode_ci NOT NULL COMMENT 'รหัสการลางาน',
  `USER_ID` char(6) COLLATE utf8_unicode_ci NOT NULL COMMENT 'รหัสผู้ใช้งาน',
  `START_DATE` date NOT NULL COMMENT 'วันที่เริ่มลางาน',
  `END_DATE` date NOT NULL COMMENT 'วันที่สิ้นสุดลางาน',
  `CREATED_DATE` date NOT NULL COMMENT 'วันที่เขียนคำร้อง',
  `TYPE_LEAVE` char(1) COLLATE utf8_unicode_ci NOT NULL COMMENT 'ประเภทการลา เช่น 1 = ลากิจ, 2 = ลาป่วย, 3 = ลาพัก',
  `REASON_LEAVE` varchar(150) COLLATE utf8_unicode_ci NOT NULL COMMENT 'เหตุผลการลา'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `formleave` (`LEAVE_ID`, `USER_ID`, `START_DATE`, `END_DATE`, `CREATED_DATE`, `TYPE_LEAVE`, `REASON_LEAVE`) VALUES
('6201160001', '180001', '2019-01-17', '2019-01-19', '2019-01-16', '2', 'ป่่วยจ้า'),
('6201160002', '180001', '2019-01-12', '2019-01-12', '2019-01-16', '1', ''),
('6201160003', '180001', '2019-01-12', '2019-01-26', '2019-01-16', '3', ''),
('6201160005', '180001', '2019-01-18', '2019-01-19', '2019-01-16', '1', '123');
...
CREATE TABLE `initial` (
  ...
  `INITIAL_NAME` varchar(30) COLLATE utf8_unicode_ci NOT NULL COMMENT 'ชื่อคำนำหน้า'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `notifications` (
  `id` int(6) NOT NULL,
  `LEAVE_ID` char(10) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `notifications` (`id`, `LEAVE_ID`, `status`) VALUES
(64, '6201160002', 1),
(65, '6201160003', 1),
(66, '6201160004', 1),
(67, '6201160004', 1),
...
CREATE TABLE `position` (
  `POSITION_ID` int(3) NOT NULL COMMENT 'รหัสหน่วยงาน',
  `POSITION_NAME` varchar(50) COLLATE utf8_unicode_ci NOT NULL COMMENT 'ชื่อหน่วยงาน',
  `DEPARTMEMT_ID` char(3) COLLATE utf8_unicode_ci NOT NULL COMMENT 'รหัสหน่วยงาน'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `position` (`POSITION_ID`, `POSITION_NAME`, `DEPARTMEMT_ID`) VALUES
(1, 'พนักงานรับจ่ายเงิน', '1'),
(2, 'พนักงานตรวจสอบสินค้า', '1'),
(3, 'พนักงานบันทึกรายได้', '2'),
(4, 'หัวหน้าแผนก', '1');
...
INSERT INTO `provinces` (`PROVINCE_ID`, `code`, `PROVINCE_NAME`, `name_en`, `geography_id`) VALUES
...
CREATE TABLE `user` (
  `USER_ID` char(6) COLLATE utf8_unicode_ci NOT NULL COMMENT 'รหัสพนักงาน',
  `USERNAME` varchar(15) COLLATE utf8_unicode_ci NOT NULL COMMENT 'ชื่อผู้ใช้',
  `PASSWORD` varchar(15) COLLATE utf8_unicode_ci NOT NULL COMMENT 'รหัสผ่าน',
  `INITIAL_ID` int(2) NOT NULL COMMENT 'คำนำหน้าชื่อ',
  ...
  `POSITION_ID` char(3) COLLATE utf8_unicode_ci NOT NULL COMMENT 'ตำแหน่ง',
  `DEPARTMENT_ID` char(3) COLLATE utf8_unicode_ci NOT NULL COMMENT 'หน่วยงาน',
  `ADDRESS` varchar(80) COLLATE utf8_unicode_ci NOT NULL COMMENT 'ที่อยู่',
  `DISTRICT_ID` char(6) COLLATE utf8_unicode_ci NOT NULL COMMENT 'ตำบล',
  `AMPHUR_ID` char(6) COLLATE utf8_unicode_ci NOT NULL COMMENT 'อำเภอ',
  `PROVINCE_ID` char(3) COLLATE utf8_unicode_ci NOT NULL COMMENT 'จังหวัด',
  `PHONE` char(10) COLLATE utf8_unicode_ci NOT NULL COMMENT 'เบอร์โทรศัพท์',
  `USER_TYPE` char(1) COLLATE utf8_unicode_ci NOT NULL COMMENT 'ประเภทผู้ใช้งาน เช่น 1 = พนักงาน, 2 = ผู้อนุมัติ, 3 = ผู้ดูแลระบบ',
  `image` varchar(50) COLLATE utf8_unicode_ci DEFAULT 'user'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `user` (`USER_ID`, `USERNAME`, `PASSWORD`, `INITIAL_ID`, `FIRST_NAME`, `LAST_NAME`, `POSITION_ID`, `DEPARTMENT_ID`, `ADDRESS`, `DISTRICT_ID`, `AMPHUR_ID`, `PROVINCE_ID`, `PHONE`, `USER_TYPE`, `image`) VALUES
('180000', '444', '444', 1, 'admin', 'admin', '3', '2', '444------', '210202', '152', '12', '444', '3', '20190116As0GcbY2or.jpg'),
('180001', '111', '111', 1, 'กกก', 'กกก', '2', '1', '111', '241002', '187', '15', '111', '1', '20181104fgkNRKR3VH.jpg'),
('180002', '222', '222', 1, '222', '222', '4', '1', '222', '270307', '208', '18', '222', '2', '20181031JDfltaL23m.png'),
('180003', '555', '555', 1, '555', '555', '3', '2', ';;;;;;', '251008', '198', '16', '555', '1', ''),
('610004', 'ะำพ', 'ะำพะำพะ', 1, 'ำพะำพะ', 'ำพะำพะ', '3', '2', 'ำพะำพะ', '251008', '198', '16', '5645645', '1', '');
...
--
ALTER TABLE `department`
  MODIFY `DEPARTMEMT_ID` int(3) NOT NULL AUTO_INCREMENT COMMENT 'รหัสหน่วยงาน', AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `initial`
--
ALTER TABLE `initial`
  MODIFY `INITIAL_ID` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `position`
  MODIFY `POSITION_ID` int(3) NOT NULL AUTO_INCREMENT COMMENT 'รหัสหน่วยงาน', AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `provinces`
--
ALTER TABLE `provinces`
  MODIFY `PROVINCE_ID` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;
COMMIT;
